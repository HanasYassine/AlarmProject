    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (!this.isRunning && startId == 1) {
            ...
            if (whale_sound_choice == 0) {
                ...
                if (whale_number == 1) {
                    media_song = MediaPlayer.create(this, R.raw.banana_song);
                    media_song.start();
                }
                else if (whale_number == 2) {
                    // create an instance of the media player
                    media_song = MediaPlayer.create(this, R.raw.darth_vader);
                    // start the ringtone
                    media_song.start();
                }
                    ...
                    media_song = MediaPlayer.create(this, R.raw.very_super_tone_ever);
                    media_song.start();
                }
